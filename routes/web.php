...
// Page d'accueil par défaut de Laravel
...
// ROUTE DÉPLACÉE ICI POUR ACCÈS DIRECT

// C'est cette ligne qui permet d'afficher ton tableau "rouge et bleu"

Route::get('/historique', [\App\Http\Controllers\LogController::class, 'index'])->name('logs.historique');



// Routes protégées (Change Tracking and Audit)
